///////////////////////////////////////////////////
/// File: mnm_rtr_unoc_FBAXI_signal_defines.sv
...
///////////////////////////////////////////////////
    ...
    mnm_pkg::unoc_channel_e                            u_noc_in_channel;
    mnm_pkg::unoc_channel_e                            u_noc_out_channel;                        
    ...
    logic [mnm_pkg::MNM_UAXI_AW_ADDR_WIDTH-1:0]        unoc_in_awaddr;
    logic [mnm_pkg::MNM_UAXI_AW_USER_WIDTH-1:0]        unoc_in_awuser;
                                              
    logic [mnm_pkg::MNM_UAXI_ID_LEN_WIDTH-1:0]         unoc_in_awlen;
    logic [mnm_pkg::MNM_UAXI_AW_SIZE_WIDTH-1:0]        unoc_in_awsize;
    logic [mnm_pkg::MNM_UAXI_AW_ID_WIDTH-1:0]          unoc_in_awid;
    logic [mnm_pkg::MNM_UAXI_ID_IID_WIDTH-1:0]         unoc_in_awiid;
    logic                                              unoc_in_wlast;
    logic [mnm_pkg::MNM_UAXI_ID_LEN_WIDTH-1:0]         wdata_items_seen_AW;  // unoc_in_channel
    logic [mnm_pkg::MNM_UAXI_ID_LEN_WIDTH-1:0]         wdata_items_seen_R;  // unoc_in_channel

    //b channel
    logic                                              unoc_in_bvalid;
    logic [mnm_pkg::MNM_UAXI_B_ID_WIDTH-1:0]           unoc_in_bid;
    logic [mnm_pkg::MNM_UAXI_ID_IID_WIDTH-1:0]         unoc_in_biid;
    logic [mnm_pkg::MNM_UAXI_B_USER_WIDTH-1:0]         unoc_in_buser;
    logic [mnm_pkg::MNM_UAXI_ID_LEN_WIDTH-1:0]         unoc_in_blen;

    //ar channel
    logic                                              unoc_in_arvalid;
    logic [mnm_pkg::MNM_UAXI_AR_ID_WIDTH-1:0]          unoc_in_arid;
    logic [mnm_pkg::MNM_UAXI_ID_IID_WIDTH-1:0]         unoc_in_ariid;
    logic [mnm_pkg::MNM_UAXI_ID_LEN_WIDTH-1:0]         unoc_in_arlen;
    logic [mnm_pkg::MNM_UAXI_AR_USER_WIDTH-1:0]        unoc_in_aruser;
    logic [mnm_pkg::MNM_UAXI_AR_SIZE_WIDTH-1:0]        unoc_in_arsize;
    logic [mnm_pkg::MNM_UAXI_AR_ADDR_WIDTH-1:0]        unoc_in_araddr;

    //r channel
    logic                                              unoc_in_rvalid;
    logic [mnm_pkg::MNM_UAXI_R_ID_WIDTH-1:0]           unoc_in_rid;
    logic [mnm_pkg::MNM_UAXI_ID_IID_WIDTH-1:0]         unoc_in_riid;
    logic [mnm_pkg::MNM_UAXI_R_USER_WIDTH-1:0]         unoc_in_ruser;
    logic                                              unoc_in_rlast;
    logic [mnm_pkg::MNM_UAXI_ID_LEN_WIDTH-1:0]         unoc_in_rlen;
    ...
    logic [mnm_pkg::MNM_ID_WIDTH-1:0]                  unoc_in_tgtid_mnm_id;
    ...
    logic [mnm_pkg::MNM_ID_WIDTH-1:0]                  unoc_in_srcid_mnm_id;
    ...
    logic [mnm_pkg::MNM_ID_WIDTH-1:0]                  unoc_out_srcid_mnm_id;
    ...
    logic [mnm_pkg::MNM_ID_WIDTH-1:0]                  unoc_in_resp_orgid_mnm_id;

    logic                                              unoc_out_awvalid;
    logic [mnm_pkg::MNM_UAXI_AW_ADDR_WIDTH-1:0]        unoc_out_awaddr;
    logic [mnm_pkg::MNM_UAXI_AW_USER_WIDTH-1:0]        unoc_out_awuser;
                                              
    logic [mnm_pkg::MNM_UAXI_ID_LEN_WIDTH-1:0]         unoc_out_awlen;
    logic [mnm_pkg::MNM_UAXI_AW_SIZE_WIDTH-1:0]        unoc_out_awsize;
    logic [mnm_pkg::MNM_UAXI_AW_ID_WIDTH-1:0]          unoc_out_awid;
    logic [mnm_pkg::MNM_UAXI_ID_IID_WIDTH-1:0]         unoc_out_awiid;
    logic                                              unoc_out_wlast;

    //b channel
    logic                                              unoc_out_bvalid;
    logic [mnm_pkg::MNM_UAXI_B_ID_WIDTH-1:0]           unoc_out_bid;
    logic [mnm_pkg::MNM_UAXI_ID_IID_WIDTH-1:0]         unoc_out_biid;
    logic [mnm_pkg::MNM_UAXI_B_USER_WIDTH-1:0]         unoc_out_buser;
    logic [mnm_pkg::MNM_UAXI_ID_LEN_WIDTH-1:0]         unoc_out_blen;

    //ar channel
    logic                                              unoc_out_arvalid;
    logic [mnm_pkg::MNM_UAXI_AR_ID_WIDTH-1:0]          unoc_out_arid;
    logic [mnm_pkg::MNM_UAXI_ID_IID_WIDTH-1:0]         unoc_out_ariid;
    logic [mnm_pkg::MNM_UAXI_ID_LEN_WIDTH-1:0]         unoc_out_arlen;
    logic [mnm_pkg::MNM_UAXI_AR_USER_WIDTH-1:0]        unoc_out_aruser;
    logic [mnm_pkg::MNM_UAXI_AR_SIZE_WIDTH-1:0]        unoc_out_arsize;
    logic [mnm_pkg::MNM_UAXI_AR_ADDR_WIDTH-1:0]        unoc_out_araddr;

    //r channel
    logic                                              unoc_out_rvalid;
    logic [mnm_pkg::MNM_UAXI_R_ID_WIDTH-1:0]           unoc_out_rid;
    logic [mnm_pkg::MNM_UAXI_ID_IID_WIDTH-1:0]         unoc_out_riid;
    logic [mnm_pkg::MNM_UAXI_R_USER_WIDTH-1:0]         unoc_out_ruser;
    logic                                              unoc_out_rlast;
    logic [mnm_pkg::MNM_UAXI_ID_LEN_WIDTH-1:0]         unoc_out_rlen;
    ...
    assign unoc_in_tgtid_mnm_id                        = unoc_in_is_AW_W_channel ? u_noc_in.payload.uaxi_combo_aw_w.aw.user.tgt_id.mnm_id      :
                                                         unoc_in_is_AR_channel   ? u_noc_in.payload.uaxi_ar.user.tgt_id.mnm_id                 : 
                                                         unoc_in_is_R_channel    ? u_noc_in.payload.uaxi_r.id.originator_id.mnm_id             :
                                                         unoc_in_is_B_channel    ? u_noc_in.payload.uaxi_b.id.originator_id.mnm_id             : 
                                                         '0;
    ...
    assign unoc_in_resp_orgid_mnm_id                   = unoc_in_is_R_channel    ? u_noc_in.payload.uaxi_r.id.originator_id.mnm_id             :
                                                         unoc_in_is_B_channel    ? u_noc_in.payload.uaxi_b.id.originator_id.mnm_id             : 
                                                         '0;
    ...
    assign unoc_in_srcid_mnm_id                        = unoc_in_is_AW_W_channel ? u_noc_in.payload.uaxi_combo_aw_w.aw.id.originator_id.mnm_id :
                                                          unoc_in_is_AR_channel   ? u_noc_in.payload.uaxi_ar.id.originator_id.mnm_id            : 
                                                          unoc_in_is_R_channel    ? u_noc_in.payload.uaxi_r.user.src_id.mnm_id                  :
                                                          unoc_in_is_B_channel    ? u_noc_in.payload.uaxi_b.user.src_id.mnm_id                  : 
                                                          '0;
    ...
    assign unoc_out_srcid_mnm_id                        = unoc_out_is_AW_W_channel ? u_noc_out.payload.uaxi_combo_aw_w.aw.id.originator_id.mnm_id :
                                                          unoc_out_is_AR_channel   ? u_noc_out.payload.uaxi_ar.id.originator_id.mnm_id            : 
                                                          unoc_out_is_R_channel    ? u_noc_out.payload.uaxi_r.user.src_id.mnm_id                  :
                                                          unoc_out_is_B_channel    ? u_noc_out.payload.uaxi_b.user.src_id.mnm_id                  : 
                                                          '0;
