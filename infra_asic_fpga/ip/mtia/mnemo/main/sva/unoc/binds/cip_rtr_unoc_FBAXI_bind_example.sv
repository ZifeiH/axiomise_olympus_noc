/////////////////////////////////////////////////////////////////////////////////////////
// File: cip_rtr_unoc_FBAXI_bind.sv
// This file bind UNOC FBAXI testbench with rtl
/////////////////////////////////////////////////////////////////////////////////////////

module cip_rtr_unoc_fbaxi_bind;
      
  //crtr
  bind cip_rtr fbaxi_unoc_protocol_checker
  #(
    .UNOC_MASTER(1)
  )
...
//irtr
 ...
 bind cip_rtr cip_rtr_unoc_FBAXI_sva #(
        .STUB_FULL       (STUB_FULL),
        .STUB_DCNOC      (STUB_DCNOC),
        .STUB_CRTR       (STUB_CRTR),
        .STUB_IRTR       (STUB_IRTR),
        .CIP_RTR_DRIVE_0 (CIP_RTR_DRIVE_0) 
  ) u_cip_rtr_unoc_FBAXI_sva  (.*);
...
/////////////////
  ...
  u_cip_rtr_u_irtr2n_unoc_slave_e2e
  (
    .clk(clk),
    .reset_n(reset_n),
  ...
  u_cip_rtr_u_irtr2s_unoc_slave_e2e
  (
    .clk(clk),
    .reset_n(reset_n),
  ...
  u_cip_rtr_u_irtr2e_unoc_slave_e2e
  (
    .clk(clk),
    .reset_n(reset_n),
  ...
  u_cip_rtr_u_irtr2w_unoc_slave_e2e
  (
    .clk(clk),
    .reset_n(reset_n),
  ...
  u_cip_rtr_u_irtr2lf0_unoc_slave_e2e
  (
    .clk(clk),
    .reset_n(reset_n),
  ...
  u_cip_rtr_u_irtr2lf1_unoc_slave_e2e
  (
    .clk(clk),
    .reset_n(reset_n),
  ...
  u_cip_rtr_u_crtr2lf0_unoc_slave_e2e
  (
    .clk(clk),
    .reset_n(reset_n),
  ...
  u_cip_rtr_u_crtr2lf1_unoc_slave_e2e
  (
    .clk(clk),
    .reset_n(reset_n),
...
endmodule : cip_rtr_unoc_fbaxi_bind
