...
/////////////////////////////////////////////////////////////////////////////////////////
  logic [mnm_pkg::MNM_CONTROL_NOC_CHANNEL_WIDTH-1:0]                c_noc_in_channel;
  logic                                                             c_noc_in_is_ar_channel;
  logic                                                             c_noc_in_is_b_channel;

  logic [mnm_pkg::MNM_DAXI_ARUSER_VC_WIDTH-1:0]                     c_noc_in_vc;
  logic [mnm_pkg::MNM_DAXI_ID_IID_WIDTH-1:0]                        c_noc_in_iid;
  logic                                                             c_noc_in_read;
  ...
  logic [mnm_pkg::MNM_DAXI_B_ID_WIDTH-1:0]                          c_noc_in_bid;
  ...
  assign c_noc_in_vc                                    = c_noc_in_is_ar_channel ? c_noc_in.payload.daxi_ar.user.vc:c_noc_in.payload.daxi_b.user.vc;
  assign c_noc_in_iid                                   = c_noc_in_is_ar_channel ? c_noc_in.payload.daxi_ar.id.iid :c_noc_in.payload.daxi_b.id.iid; 
  assign c_noc_in_read                                  = c_noc_in.channel == mnm_pkg::CNOC_CHANNEL_E_AR;
