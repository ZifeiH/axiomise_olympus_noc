///////////////////////////////////////////////////
/// File: cip_mrtr_unoc_credit_release_sva.sv
/// This file contains the assumptions related to credit_release
/////////////////////////////////////////////////// 

module cip_mrtr_unoc_credit_release_sva # (
...
//------------------------------------------------------------------------------
   ...
   localparam UNOC_AW_W_R_CRED_RX                    = (SIDE == cip_rtr_pkg::UNOC_DIR_WEST)    ?  cip_pkg::CIP_MRTR_EW_INTF_AW_W_R_CREDITS_UNOC    : 
                                                       (SIDE == cip_rtr_pkg::UNOC_DIR_EAST)    ?  cip_pkg::CIP_MRTR_EW_INTF_AW_W_R_CREDITS_UNOC    :
                                                       ...
                                                       (SIDE == cip_rtr_pkg::UNOC_DIR_LEAF0)   ?  cip_pkg::CIP_MRTR_FI_INTF_AW_W_R_CREDITS_UNOC    :
                                                       (SIDE == cip_rtr_pkg::UNOC_DIR_LEAF1)   ?  cip_pkg::CIP_MRTR_FI_INTF_AW_W_R_CREDITS_UNOC    :
                                                       '0;

   localparam UNOC_AR_B_CRED_RX                      = (SIDE == cip_rtr_pkg::UNOC_DIR_WEST)    ?  cip_pkg::CIP_MRTR_EW_INTF_AR_B_CREDITS_UNOC    : 
                                                       (SIDE == cip_rtr_pkg::UNOC_DIR_EAST)    ?  cip_pkg::CIP_MRTR_EW_INTF_AR_B_CREDITS_UNOC    :
                                                       ...
                                                       (SIDE == cip_rtr_pkg::UNOC_DIR_LEAF0)   ?  cip_pkg::CIP_MRTR_FI_INTF_AR_B_CREDITS_UNOC    :
                                                       (SIDE == cip_rtr_pkg::UNOC_DIR_LEAF1)   ?  cip_pkg::CIP_MRTR_FI_INTF_AR_B_CREDITS_UNOC    :
                                                       '0;
...
//------------------------------------------------------------------------------ 
  generate 
    if((`is_sw_corner_RTR && SIDE == WEST) || (`is_se_corner_RTR && SIDE == EAST)) begin
      ...
      `SV_ASSERT(FVPH_RTR_FV_am_no_credit_back_from_W_E_at_sw_se,     !|u_noc_in_credit_release);
    end
  endgenerate

    generate if(!((`is_sw_corner_RTR && SIDE == WEST) || ( `is_se_corner_RTR && SIDE == EAST))) begin
      if (GEN_RX_ASM) begin: rx_credit_checker
        for (genvar i = 0 ; i < cip_pkg::CIP_UNOC_AR_NUM_VC; i++ ) begin: ar_req
            credit_counter_RX_sva # (
                ...
                .noc_in_valid              (u_noc_in_valid && unoc_in_is_AR_channel),
        ...
        for (genvar i = 0 ; i < cip_pkg::CIP_UNOC_R_NUM_VC; i++ ) begin: r_resp
            credit_counter_RX_sva # (
                ...
                .noc_in_valid              (u_noc_in_valid && unoc_in_is_R_channel), 
        ...
        for (genvar i = 0 ; i < cip_pkg::CIP_UNOC_B_NUM_VC; i++ ) begin: b_resp
            credit_counter_RX_sva # (
                ...
                .noc_in_valid              (u_noc_in_valid && unoc_in_is_B_channel),
      ...
      if (GEN_TX_ASM) begin: tx_credit_checker
        for (genvar i = 0 ; i < cip_pkg::CIP_UNOC_AR_NUM_VC; i++ ) begin: ar_req
            credit_counter_TX_sva # (
                ...
                .noc_out_valid             (u_noc_out_valid && unoc_out_is_AR_channel),
        ...
        for (genvar i = 0 ; i < cip_pkg::CIP_UNOC_R_NUM_VC; i++ ) begin: r_resp
            credit_counter_TX_sva # (
                ...
                .noc_out_valid             (u_noc_out_valid && unoc_out_is_R_channel),
        ...
        for (genvar i = 0 ; i < cip_pkg::CIP_UNOC_B_NUM_VC; i++ ) begin: b_resp
            credit_counter_TX_sva # (
                ...
                .noc_out_valid             (u_noc_out_valid && unoc_out_is_B_channel),
