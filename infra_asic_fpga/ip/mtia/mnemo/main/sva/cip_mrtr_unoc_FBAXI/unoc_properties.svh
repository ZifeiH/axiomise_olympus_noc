///////////////////////////////////////////////////
/// File: unoc_properties.svh
/// This file constains the properties for MRTR UNOC FBAXI
///////////////////////////////////////////////////
  ...
  property unoc_resp_ttl_always_at_most_16;
    unoc_resp_valid |-> unoc_resp_bundle.ttl <= cip_pkg::CIP_NOC_TTL_DEFAULT;  // 'never zero' same as 'at least 1' (for unsigned numbers)
  endproperty
